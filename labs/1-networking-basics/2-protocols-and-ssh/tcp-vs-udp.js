 ...
 *
 * 🧒 সহজ ভাষায়: TCP হলো ট্র্যাকিং-সহ চিঠি পাঠানোর মতো — পোস্ট অফিস নিশ্চিত করে
 * চিঠিটা ঠিক জায়গায়, ঠিক ক্রমে পৌঁছাবে (দরকার হলে আবার পাঠাবে)। UDP হলো মাঠের
 * ওপার থেকে বন্ধুকে চিৎকার করে কথা বলার মতো — অনেক দ্রুত, কিন্তু বাতাসে কিছু কথা
 * হারিয়েও যেতে পারে, আর কেউ শুনতে পেলো কিনা তুমি নিশ্চিত না।
 *
 * কী দেখাবে:
...
tcpServer.listen(TCP_PORT, () => {
  udpServer.bind(UDP_PORT, () => {
    ...
    console.log("🧒 মনে রাখো: TCP = ট্র্যাকিং-সহ চিঠি (নিশ্চিত পৌঁছাবে), UDP = মাঠের ওপার থেকে চিৎকার (দ্রুত, কিন্তু কিছু কথা হারিয়ে যেতে পারে)\n");
